...
public class ViewFlightJPanel extends javax.swing.JPanel {
    ...
    ViewFlightJPanel(JPanel bottomPanel, Customer c, CustomerDirectory custDir) {
        initComponents();
    ...
    @SuppressWarnings("unchecked")
     ...
     private void populateFlightDetails() {
         ...
         FlightNumTxt.setText(customer.getFlightNum());
         ArrivalTxt.setText(customer.getArrival());
         DeptTxt.setText(customer.getDeparture());
         prefTimeTxt.setText(customer.getPrefTime());
         DateTxt.setText(customer.getDate());
         priceTxt.setText(String.valueOf(customer.getPrice()));
         availSeatsTxt.setText(String.valueOf(customer.getAvailSeats()));

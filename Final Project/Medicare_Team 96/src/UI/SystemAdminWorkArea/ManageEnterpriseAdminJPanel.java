...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        Employee employee = enterprise.getEmployeeDirectory().createEmployee(name, name, name, name);
        
        UserAccount account = enterprise.getUserAccountDirectory().createEmployeeAccount(username, password, new SystemAdminRole(), employee);
        populateTable();

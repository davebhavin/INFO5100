...
public class SelectDeliveryJFrame extends javax.swing.JFrame {
    ...
    public SelectDeliveryJFrame(EcoSystem system, JPanel panel, Network net, Pharmacy pharmacy,Department department, OrderRequest selectedOrder, Enterprise en) {
    ...
    private void selectBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectBtnActionPerformed
        ...
        if (deliveryList.getSelectedValue() != null) {
            ...
            de.getWorkQ().getWorkRequestList().add(dr);

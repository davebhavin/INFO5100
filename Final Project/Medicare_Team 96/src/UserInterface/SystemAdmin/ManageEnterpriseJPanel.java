    ...
    private void populateTable() {
        ...
        for (Network network : system.getNetworkList()) {
            for (Enterprise enterprise : network.getEnterpriseDir().getEnterpriseList()) {
                ...
                row[1] = network.getId();
//                row[2] = department.getDepartment();
    ...
    private void populateComboBox() {
        ...
        for (Department.departmenttype type : Department.departmenttype.values()) {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        Department.departmenttype type = (Department.departmenttype) enterpriseTypeJComboBox.getSelectedItem();
        ...
        Enterprise enterprise = network.getEnterpriseDir().createAndAddEnterprise(name,address,phone,type);
